    ...
    <div class="form-grid">
        ...
        <div class="form-group">
            ...
            <select name="jenis_obat">
                ...
                <option value="Tablet"
                    {{ $penerimaan->jenis_obat == 'Tablet' ? 'selected' : '' }}>
                    Tablet
                </option>

                <option value="Kapsul"
                    {{ $penerimaan->jenis_obat == 'Kapsul' ? 'selected' : '' }}>
                    Kapsul
                </option>

                <option value="Sirup"
                    {{ $penerimaan->jenis_obat == 'Sirup' ? 'selected' : '' }}>
                    Sirup
                </option>

                <option value="Salep"
                    {{ $penerimaan->jenis_obat == 'Salep' ? 'selected' : '' }}>
                    Salep
                </option>
        ...
        <div class="form-group">
            ...
            <input type="text"
                   name="dosis"
                   value="{{ old('dosis', $penerimaan->dosis) }}">
        </div>
